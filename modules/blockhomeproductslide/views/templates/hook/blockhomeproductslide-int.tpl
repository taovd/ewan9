...
<div class="outer-container">
  ...
  <div class="container">
    <div class="other-pro list-tab">
		{if $fswitch == "1"}
        {if isset($featured_products) && $featured_products}<div class="fns-title"><span>{l s='Featured Products' mod='blockhomeproductslide'}</span></div>{else}{/if}
          <div class="fns-slider">
            <div class="slider-inner">
             {if isset($featured_products) && $featured_products}
           	<div class="navslider-control">
            	<div class="navslider1"> <a class="prev" href="#">Prev</a> <a class="next" href="#">Next</a> </div>
            </div>
            {/if}
              <div class="container-slider">
              
                <div class="products-grid homepro1"> 
                    ...
                    <div class="item-wrap">
                      <div class="border_inside">
                        <div class="prodfns_img">
                         ...
                         <div class="prodc_img">
                         		<a href="{$product.link}" title="{$product.name|escape:html:'UTF-8'}" class="product_image"> <img src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'home_default')|escape:'html':'UTF-8'}" height="{$homeSize.height}" width="{$homeSize.width}" alt="{$product.name|escape:html:'UTF-8'}"/> </a>
        ...
        {/if}
        {if $nswitch == "1"}
        <div class="fns-spacer"></div>
         {if isset($new_products) && $new_products}<div class="fns-title"><span>{l s='New Arrivals' mod='blockhomeproductslide'}</span></div>{else} {/if}
          <div class="fns-slider">
            <div class="slider-inner">
            {if isset($new_products) && $new_products}
            <div class="navslider-control">
            	<div class="navslider2"> <a class="prev" href="#">Prev</a> <a class="next" href="#">Next</a> </div>
            </div>
             {/if}
              <div class="container-slider">
                <div class="products-grid homepro2"> 
            {if isset($new_products) && $new_products}
        ...
        {if $tswitch == "1"}
        <div class="fns-spacer"></div>
         {if isset($bestsellers) && $bestsellers}<div class="fns-title"><span>{l s='Top Sellers' mod='blockhomeproductslide'}</span></div>{else} {/if}
          <div class="fns-slider">
            <div class="slider-inner">
            {if isset($bestsellers) && $bestsellers}
            <div class="navslider-control">
            	<div class="navslider3"> <a class="prev" href="#">Prev</a> <a class="next" href="#">Next</a> </div>
            </div>
            {/if}
              <div class="container-slider">
                <div class="products-grid homepro3"> {if isset($bestsellers) && $bestsellers}
        ...
        {if $sswitch == "1"}
        	<div class="fns-spacer"></div>
         {if isset($specials) && $specials}<div class="fns-title"><span>{l s='Special Products' mod='blockhomeproductslide'}</span></div>{else} {/if}
          <div class="fns-slider">
            <div class="slider-inner">
            {if isset($specials) && $specials}
            <div class="navslider-control">
            	<div class="navslider4"> <a class="prev" href="#">Prev</a> <a class="next" href="#">Next</a> </div>
            </div>
            {/if}
              <div class="container-slider">
                <div class="products-grid homepro4"> {if isset($specials) && $specials}
