...
<section id="newsletter_block_left" class="footer-block col-xs-12 col-omi-xs5 blocks">
	<h4>{l s='Newsletter' mod='blockariesnewsletter'}</h4>
...
{/if}
{addJsDefL name=placeholder_blocknewsletter}{l s='Enter your e-mail' mod='blockariesnewsletter' js=1}{/addJsDefL}
{if isset($msg) && $msg}
	{addJsDefL name=alert_blocknewsletter}{l s='Newsletter : %1$s' sprintf=$msg js=1 mod="blockariesnewsletter"}{/addJsDefL}
{/if}
{/strip}